...
1. The objects you will need to _**arrange**_ in a test (the injected parameters)
2. The post-conditions you likely want to _assert_ in a test
    1. Expected _collaborations_ (e.g. method calls) with test doubles / mocked components from underlying layers
